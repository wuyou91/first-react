...
export default class Comment extends React.Component {
    ...
    remove(index) {
        const commentsLsit = this.state.commentsLsit
        commentsLsit.splice(index,1)
        this.setState({ commentsLsit })
    }
    componentDidMount() {
        this.textarea.focus()
    }
            ...
            <div className="comment">
                <div className="wrap">
                    <div className="form">
                        ...
                        <textarea ref={(d) => this.textarea = d} type="text" placeholder="请输入评论内容" value={this.state.content} onChange={this.changeContent.bind(this)} />
                        <button onClick={this.submit.bind(this)}>提交</button>
                    </div>
                    {this.state.commentsLsit.length
